    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                setTimeout(() => {
                    // Por ahora redirigir a preguntas, se puede ajustar según el rol cuando se implemente
                    navigate('/preguntas');
                }, 1000);
            } else {
                ...
                setSubmitMessage({ 
                    type: 'error', 
                    text: result.error || 'Credenciales incorrectas. Por favor intenta nuevamente.' 
                });
            }
        } catch (error) {
